...
import androidx.room.PrimaryKey;
    ...
    public class Product {
        ...
        private int brandId;       // Khóa ngoại tới Brand
        private int categoryId;    // Khóa ngoại tới Category

        // Constructor
        public Product(String productName, double price, int quantity, int sellingPrice,
