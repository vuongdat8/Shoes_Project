...
//        categories.add(new Category(UUID.randomUUID(), "Sneaker", "Casual and sports shoes"));
//        categories.add(new Category(UUID.randomUUID(), "Running", "Shoes designed for running"));
//        categories.add(new Category(UUID.randomUUID(), "Sandals", "Open-toe footwear for comfort"));
//        categories.add(new Category(UUID.randomUUID(), "Boots", "Footwear that covers the ankle and lower leg"));
//        categories.add(new Category(UUID.randomUUID(), "Loafers", "Slip-on shoes for casual wear"));
//        categories.add(new Category(UUID.randomUUID(), "Sport", "Footwear for various sports activities"));
//
...
//        brands.add(new Brand(UUID.randomUUID(), "Puma", "Fast fashion clothing"));
//        brands.add(new Brand(UUID.randomUUID(), "Converse", "Fast fashion clothing"));
//        brands.add(new Brand(UUID.randomUUID(), "New Balance", "Sports and lifestyle products"));
//        brands.add(new Brand(UUID.randomUUID(), "Vans", "Denim and casual wear"));
//        brands.add(new Brand(UUID.randomUUID(), "Bitis", "Sports and lifestyle products"));
//        brands.add(new Brand(UUID.randomUUID(), "Jordan", "Luxury leather goods and accessories"));
//
...
//                                  int stock, int sold,  String image) {
