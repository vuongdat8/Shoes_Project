...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* 6. Nút Go Home */
        btnGoHome.setOnClickListener(v -> {
            boolean isAdmin = sp.getBoolean("role", false);

            Intent intent = isAdmin
                    ? new Intent(this, Home_Admin_Activity.class)
                    : new Intent(this, CustomerProductListActivity.class);

            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
        });

        /* 7. Init Google Sign-In (để logout đúng cách) */
    ...
    private void doLogout() {
        ...
        googleClient.signOut().addOnCompleteListener(task -> {
            // D. Về màn Login và xoá back stack
            Intent i = new Intent(this, LoginActivity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(i);
        });
